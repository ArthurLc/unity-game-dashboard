...
namespace GameDashboard.Editor
{
    public class GameDashboardWindow : EditorWindow
    {
        ...
        [MenuItem("Window/Game Dashboard %g", priority = 20)]
        public static void ShowWindow()
        {
            var win = GetWindow<GameDashboardWindow>();
            win.titleContent = new GUIContent("Game Dashboard", EditorGUIUtility.IconContent(ICON).image);
        }
        ...
        public static bool HasUIToolkitInspector(Editor editor)
        {
            ...
            return method != null && method.DeclaringType != typeof(Editor);
        }
        #endregion
    }
}
