...
namespace GameDashboard.Editor
{
    ...
    [InitializeOnLoad]
#endif
    public class GameDashboardShortcutButton : Editor
    {
#if UNITY_6000_3_OR_NEWER
        ...
        private static void OnToolbarGUI()
        {
            ...
            if (GUILayout.Button(new GUIContent(EditorGUIUtility.IconContent("Settings").image, "Game Dashboard"), ToolbarStyles.commandButtonStyle))
            {
