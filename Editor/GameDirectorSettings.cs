...
{
    [FilePath("GameDashboardSettings.asset", FilePathAttribute.Location.ProjectFolder)]
    public class GameDashboardSettings : ScriptableSingleton<GameDashboardSettings>
    {
        [Serializable]
